...
It is possible to fine-tune the behavior in the [dependency injection container]({{< ref "/docs/recipes/dependency-injection" >}}#the-container) by enabling or disabling features for a given model element type.
